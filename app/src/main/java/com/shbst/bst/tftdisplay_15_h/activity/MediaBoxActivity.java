...
public class MediaBoxActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 注册EventBus
        eventBus.register(MediaBoxActivity.this);
        configurationParams = ConfigurationParams.getConfigurationParams(MediaBoxActivity.this);
        ...
        // 初始化web云端网络服务
        MqttService.Open_IOT_Client(MediaBoxActivity.this);
    ...
    private void showWebView() {
        ...
        lift_webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                setVideoFullscreen(view, PrefUtils.getString(MediaBoxActivity.this, "fullscreen", fillScreen));
            }
        });
    ...
    public static List<LiftLayoutParams> getLayoutList() {
        ...
        if (crossScreenNow.equals("0")) {
            ...
            listLayout_H.add(new LiftLayoutParams("time", "200", "80", "1700", "42"));
        ...
        if (event.type.equals("video")) {
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    PrefUtils.setString(MediaBoxActivity.this, Constants.rType, event.type);
                    PrefUtils.setString(MediaBoxActivity.this, Constants.rPath, resFilePath);
    ...
    public void onEventMainThread(KONE_TransformProtocol.LiftInfo event) {
        if (crossScreenNow.equals("0")) {
            if (event.getFloor().length() == 3) {
                lift_floor.setTextSize(320);
            } else {
                lift_floor.setTextSize(364);
            }
        } else {
            if (event.getFloor().length() == 3) {
                lift_floor.setTextSize(320);
        ...
        switch (event.type) {
            case MqttService._layout:
                if (event.info.equals("0") || event.info.equals("1")) {
                    crossScreenNow = "0";
                    PrefUtils.setString(this, "crossScreen", "0");
...
//                Log.i(TAG, "onEventMainThread: "+event.info);
            ...
            case MqttService.web_url:
                ...
                PrefUtils.setString(MediaBoxActivity.this, Constants.rType, Constants.WebUrl);
                PrefUtils.setString(MediaBoxActivity.this, Constants.WebUrl, event.info);
...
//                        Log.i(TAG, "run: resFilePath---" + resFilePath + "   " + resource.rType);
                        if (!resource.rType.equals("APK")) {
                            PrefUtils.setString(MediaBoxActivity.this, Constants.rType, resource.rType);
                            PrefUtils.setString(MediaBoxActivity.this, Constants.rPath, resFilePath);
                        }
...
//        Log.i(TAG, "setFillVideoShow: "+fillScreen);
        ...
        String fullscreenShow = PrefUtils.getString(MediaBoxActivity.this, "fullscreen", fillScreen);
...
//        Log.i(TAG, "setBottomVideoShow: "+fillScreen);
    ...
    private void setVideoHalfScreen(View view, String info) {
        if (crossScreenNow.equals("0")) {
            if (info.equals("1")) {
                setVideoFill(view, 1260, 895, 658, 185);
            }
        }
    }
    ...
    private void setVideoTopScreen(View view, String info) {
        if (crossScreenNow.equals("0")) {
            if (info.equals("1")) {
                setVideoFill(view, 1260, 895, 658, 0);
            }
        }
    }
    ...
    private void setVideoAllScreen(View view, String info) {
        if (crossScreenNow.equals("0")) {
            if (info.equals("1")) {
                setVideoFill(view, 1260, 1080, 658, 0);
            }
        }
    }
...
//        setVideoFullscreen(lift_video, "1");
    ...
    private void initLayout() {
        ...
        for (int i = 0; i < layoutList.size(); i++) {
            ...
            if (crossScreenNow.equals("0")) {
                ss = (LiftLayoutParams) ACache.get(MediaBoxActivity.this).getAsObject(layoutList.get(i).type + "0");
            } else {
                ss = (LiftLayoutParams) ACache.get(MediaBoxActivity.this).getAsObject(layoutList.get(i).type + "1");
            }
            if (ss == null) {
                setLayoutParams(layoutList.get(i));
            } else {
    ...
    private void setVideoFullscreen(View view, String info) {
        if (info.equals("0")) {
            setVideoFill(view, 1920, 1080, 0, 0);
        }
        if (info.equals("1")) {
            setVideoFill(view, 1260, 710, 658, 185);
        }
    }
...
//        Log.i(TAG, "setLiftFunction: "+image);
    ...
    public void initDataService() {
        Intent deviceIntent = new Intent(MediaBoxActivity.this, KONE_TransformProtocol.class);
